...
<pre style="background-color: #c6bcf5; padding: 10px; border-radius: 5px;">
...
<h2>4. 🌐 Access the API</h2>
<div style="border: 2px solid #1E90FF; padding: 10px; border-radius: 8px; background-color: #f0f8ff;">
